<template>
  <div class="bg-center bg-cover bg-no-repeat bg-[url('/hero.png')] mb-5">
    <div class="px-4">
      <div
        class="flex flex-col items-center gap-2 lg:gap-3.5 py-4 lg:pt-5 lg:pb-10"
      >
        <NuxtLink :title="namePlaceholder" :to="userInfo.url" target="_blank">
          <img
            :alt="namePlaceholder"
        ...
        <div class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm">
          <div class="flex gap-1.25 items-center">
            <Icon class="text-base-content/60" name="lucide:users" />
          ...
          <div class="flex gap-1.25 items-center">
            <Icon class="text-base-content/60" name="lucide:user-star" />
            <span class="text-base-content/60 font-medium">
