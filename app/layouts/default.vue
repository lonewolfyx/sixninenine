<template>
    <div class="flex grow w-full h-full">
        <header class="flex items-center fixed z-10 top-0 left-0 right-0 shrink-0 h-(--header-height)">
                            ...
                            <NavigationMenuList>
                                <NavigationMenuItem>
                                    <NavigationMenuLink
                                        ...
                                        target="_blank"
                                    >
                                        远方os Code Collection
                                    </NavigationMenuLink>
                                </NavigationMenuItem>
                                <NavigationMenuItem>
                                    <NavigationMenuLink
                                        :class="navigationMenuTriggerStyle()"
                                        href="https://github-profile-visualized.vercel.app"
                                        target="_blank"
                                    >
                                        Github Profile Visualized
                                    </NavigationMenuLink>
                                </NavigationMenuItem>
                                <NavigationMenuItem>
                                    <NavigationMenuLink
                                        :class="navigationMenuTriggerStyle()"
                                        href="https://vue-blocks.dev"
                                        target="_blank"
                                    >
                                        VueBlocks
                                    </NavigationMenuLink>
